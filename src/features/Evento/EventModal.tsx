...
const EventModal: FC<IEventoModal> = ({
  openNoteModal,
  setOpenNoteModal,
  children,
}) => {
  ...
  return ReactDom.createPortal(
    <>
      ...
      ></div>+-
      <div className="max-w-lg w-full overflow-y-auto relative  rounded-md fixed top-0 lg:top-[10%] left-1/2 -translate-x-1/2 bg-white z-[1001] p-6">
        {children}
      </div>
    </>,

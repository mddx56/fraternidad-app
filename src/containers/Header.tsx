          ...
          <label className="swap swap-rotate">
            ...
            <Sun
              ...
              className={
                ...
                (currentTheme === "forest" ? "swap-on" : "swap-off")
              }
            />
            <Moon
          ...
          <div className="dropdown dropdown-end ml-4">
            ...
            >
              <li className="justify-between">
                <Link to="/app/profile">Perfil Usuario</Link>
              </li>
              <li className="justify-between">
                <Link to="/app/password">Cambiar Contraseña</Link>
              </li>

              <div className="divider mt-0 mb-0"></div>

              <li className="justify-between">
                <Link to="/app/fraternidad">Fraternidad</Link>
              </li>
